...
Функция прямой: y=kx+b ![](http://latex.codecogs.com/gif.latex?y%20%3D%20kx%20&plus;%20b), следовательно: искомый коэффициент: k=(y-b)/x ![](http://latex.codecogs.com/gif.latex?k%3D%5Cfrac%7B%28y-b%29%7D%7Bx%7D)
