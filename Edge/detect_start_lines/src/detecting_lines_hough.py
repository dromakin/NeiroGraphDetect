...
def process_lines(image_src):
    ...
    cv2.imwrite('./lines_gray.jpg',gray)
    # cv2.imwrite('./lines_thresh.jpg',thresh1)
    cv2.imwrite('./lines_edges.jpg',edges)
    cv2.imwrite('./lines_lines.jpg',img)
    cv2.imwrite('./merged_lines.jpg',img_merged_lines)
...
def find_start(image):
    ...
    #             if ((inPolygon(x1, y1, x, y, w, h, r // 4) != True) &
    #                     (inPolygon(x2, y2, x, y, w, h, r // 4) != True) &
    #                     (inPolygon(x1, y1, x, y, w, h, r) == True) &
    #                     (inPolygon(x2, y2, x, y, w, h, r) == True)):
    ...
    cv2.imwrite(folder + 'lines_det.jpg', lines_edges)
